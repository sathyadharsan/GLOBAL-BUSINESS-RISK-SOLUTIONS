...
const CATEGORY_ITEMS: Record<string, { id: string; label: string; icon: React.ComponentType<{ className?: string }>; badge?: string }[]> = {
  property: [
    ...
    { id: "equipment-breakdown", label: "CPM / Machinery Breakdown", icon: Search },
    { id: "marine-cargo-2", label: "Marine Cargo / STP", icon: Anchor },
    { id: "marine-hull-2", label: "Marine Hull & Aviation", icon: Anchor },
    { id: "parametric-insurance", label: "Parametric & Index-Based", icon: Zap, badge: "New" },
  ],
  liability: [
    { id: "d-o", label: "Directors & Officers (D&O)", icon: Briefcase },
    { id: "professional-indemnity-2", label: "Professional Indemnity", icon: Scale },
    { id: "product-liability-2", label: "Product Liability & Recall", icon: Shield },
    { id: "cyber-first-party", label: "Cyber Liability", icon: Shield, badge: "Alert" },
    { id: "epli", label: "Employment Practices (EPL)", icon: ShieldAlert },
  ],
  financial: [
    { id: "trade-credit-2", label: "Trade Credit Insurance", icon: TrendingUp },
    { id: "political-risk-2", label: "Political Risk", icon: Globe },
    { id: "performance-bonds", label: "Surety Bonds & Guarantees", icon: BadgeDollarSign },
    { id: "crime-fidelity", label: "Fidelity Guarantee / Crime", icon: Shield, badge: "New" },
  ],
  motor: [
